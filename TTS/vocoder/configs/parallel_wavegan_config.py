...
class ParallelWaveganConfig(BaseGANVocoderConfig):
    ...
    Args:
        ...
        lr_scheduler_gen_params (dict):
            Parameters for the generator learning rate scheduler. Defaults to `{"gamma": 0.5**(1/200k), "last_epoch": -1}`.
        ...
        lr_scheduler_dict_params (dict):
            Parameters for the discriminator learning rate scheduler. Defaults to `{"gamma": 0.5**(1/200k), "last_epoch": -1}`.
    """
